...
delta_v_1, delta_v_2 = 0, 0
delta_v_1_temp, delta_v_2_temp = 0, 0
...
for i in range(1, len(t)):
    dt = t_1[i-1] - t_2[i-1]
    delta_v_1_temp = c_1 * (delta_v_2 * np.cos(dt) + v_2[i-1]**2*np.sin(dt)) + c_2 * np.sin(t_1[i-1])
    delta_v_2_temp = c_3 * (delta_v_1 * np.cos(dt) + v_1[i-1]**2*np.sin(dt)) + c_4 * np.sin(t_2[i-1])
    delta_v_1 = delta_v_1_temp
    delta_v_2 = delta_v_2_temp
